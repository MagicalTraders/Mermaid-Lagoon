...
const ContentEx = ({ classes }) => (
  <div className={classes.root}>
    ...
    <Typography indent="small">
      ...
      combined to create dynamic, easy-to-maintain and easy-to-code as much
      as possible.
    </Typography>
    <br />
    <br />
    ...
    <Typography component="div">
      <ol>
        <li>
          It took me a lot of time to initialize dashboard layout when I
          have new projects and I’m sure that a lot of you guys agree with
          me.
        </li>
        <li>
          Sometimes it is hard to refactor because the structure is so poor
          because someone isn’t deeply understand what he/she was doing, as
          a result, rewrite the whole layout (it actually happened, at
    ...
    <Typography>
      It must be easy enough to use, however still be able to adjust to
      compat with real word examples and usages. More importantly, it need
      to follow{' '}
      <Link
        target="_blank"
        rel="noopener"
      ...
      since we are 100% based on Material-UI with no other styling
      libraries. Last but not least, responsive is a must.
    </Typography>
    <br />
    <br />
    <br />
    ...
    <Typography>
      <b>Behavior</b> of your layout will be controlled by using config
    ...
    <Typography>
      ...
      <Link href="https://material.io/design/components/navigation-drawer.html#usage">
